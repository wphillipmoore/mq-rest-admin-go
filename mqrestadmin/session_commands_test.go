...
func TestVoidCommands(t *testing.T) {
	entries := []voidEntry{
		...
		{"AlterQalias", "ALTER", "QALIAS", func(s *Session, ctx context.Context) error { return s.AlterQalias(ctx, "OBJ") }},
		{"AlterQlocal", "ALTER", "QLOCAL", func(s *Session, ctx context.Context) error { return s.AlterQlocal(ctx, "OBJ") }},
		{"AlterQmodel", "ALTER", "QMODEL", func(s *Session, ctx context.Context) error { return s.AlterQmodel(ctx, "OBJ") }},
		{"AlterQremote", "ALTER", "QREMOTE", func(s *Session, ctx context.Context) error { return s.AlterQremote(ctx, "OBJ") }},
